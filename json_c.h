...
extern json_object *json_object_new_res(const char *oid, size_t size, const char *href_base,
                                        const char *prefix, const char *authz, int download,
                                        int upload, int code, const char *message);
